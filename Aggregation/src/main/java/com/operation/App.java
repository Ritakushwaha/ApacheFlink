...
public class App 
{
    ...
    DataStream < String > data = env.readTextFile("/home/rita/Documents/ApacheFlink/Aggregation/avg1");
    ...
    mapped.keyBy(t -> t.f0).sum(3).writeAsText("/home/rita/Documents/ApacheFlink/Aggregation/out1");

    mapped.keyBy(t -> t.f0).min(3).writeAsText("/home/rita/Documents/ApacheFlink/Aggregation/out2");

    mapped.keyBy(t -> t.f0).minBy(3).writeAsText("/home/rita/Documents/ApacheFlink/Aggregation/out3");

    mapped.keyBy(t -> t.f0).max(3).writeAsText("/home/rita/Documents/ApacheFlink/Aggregation/out4");

    mapped.keyBy(t -> t.f0).maxBy(3).writeAsText("/home/rita/Documents/ApacheFlink/Aggregation/out5");
    // execute program
